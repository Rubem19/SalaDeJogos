        ...
        <table>
            ...
            %>
                    <tr>
                        ...
                        <th><%=resultado.getString("categoria")%></th>
                        <td><a href="excur.jsp?codigo=<%=resultado.getString("nome")%>"> Excluir </a></td>
                        <td><a href="carregacurso.jsp?codigo=<%=resultado.getString("nome")%>"> Alterar </a></td>
                    </tr>
            <%       
                }
            %>
